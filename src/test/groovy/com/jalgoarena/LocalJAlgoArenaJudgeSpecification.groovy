...
@Ignore
class LocalJAlgoArenaJudgeSpecification extends Specification {
    static log = LoggerFactory.getLogger(LocalJAlgoArenaJudgeSpecification.class)

    static jalgoJudgeApiClient = new RESTClient("http://localhost:5001/")
